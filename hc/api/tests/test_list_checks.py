...
class ListChecksTestCase(BaseTestCase):
    ...
    def test_it_works(self):
        ...
        self.assertEqual(checks['Alice 1']['last_ping'], checks['Alice 2']['last_ping'])
        ...
        self.assertIn("/api/v1/checks/", checks['Alice 1']['pause_url'])
        self.assertIn("/api/v1/checks/", checks['Alice 2']['pause_url'])
